...
## Future Additions
- Adding a note or name with the added color palette
- Tapping on the left side would go back one while tapping on the right would give you a new random palette
